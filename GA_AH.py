...
class AHProblem(ElementwiseProblem):
    ...
    def __init__(self, service = 'home'):
        ...
        super().__init__(vars=vars, n_var=4, n_obj=2, n_ieq_constr=2, xl = [50, 0.75, 0.75, 1], xu = [300, 1, 0.90, 12])
    ...
    def _evaluate(self, x, out, *args, **kwargs):
        command = "Rscript detect_hiccup.R {} {} {} {} {}".format(self.service, x["l"], x["pi"], x["chi"], x["w"])
        #print(command)
        ...
        print("GA {} {} {} {} {} ".format(self.service, x["l"], x["pi"], x["chi"], x["w"]))
...
def main():
    ...
    if "GA" in args.alg:
      ...
      with open(csv_data_path, 'w', newline='') as f:
        ...
        csv_writer.writerow(['PP','AH','load','pi','chi', 'w'])
        ...
        with open(csv_exe_path, 'w', newline='') as g:
          ...
          for s in services:
            ...
            plot.save('ParetoFront/ParetoFront_GA_AH_'+s+'.pdf')
        ...
        for s in services:
            ...
            for r in range(args.repeat):
              ...
              for i in range(args.size):
                  ...
                  w = random.choice(W)
                  command = "Rscript detect_hiccup.R {} {} {} {} {}".format(s, l, pi, chi, w)
                  #print(command)
                  result = run(command, stdout=PIPE, stderr=PIPE, universal_newlines=True, shell=True)
                  #print(result.stdout.split("\n"))
                  scorePP = parse_result(result.stdout.split("\n"))[0]
                  ...
                  if scorePP > 0 and scoreAH > 0:
                    ...
                    print("RAND {} {} {} {} {} {} {}".format(s, l, pi, chi, w, scorePP, scoreAH))
                    temp="{:f} {:f} {:f} {:f} {:f} {:f}".format(scorePP, scoreAH, l, pi, chi, w)
                    temp=temp.split()
